...
const Vocabulary: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-2">
            <h1 className="text-2xl font-bold text-center mb-6">Vocabulary Management</h1>
            ...
            <Card className="mb-6 p-6">
                <div className="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div className="flex gap-2">
                        <Button onClick={applyFilters} variant="outline" className="hover:bg-emerald-600 hover:text-white">Apply</Button>
                        <Button onClick={resetFilters} variant="outline" className="hover:bg-emerald-600 hover:text-white">Reset</Button>
                        <Button onClick={() => setShowAdd(true)} variant="outline" className="hover:bg-emerald-600 hover:text-white">+ Add</Button>
                    </div>
                </div>
            </Card>
                ...
                {vocabularies.length === 0 ? (
                    ...
                    vocabularies.map(vocab => (
                        <VocabularyItem
                            ...
                            onDelete={() => setConfirmDeleteId(vocab.id)} // ✅ Dùng modal, không xoá trực tiếp
                        />
                    ))
                )}
            </div>
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-[320px]">
                        ...
                        <div className="flex justify-end gap-2">
                            <Button variant="outline" className="hover:bg-emerald-600 hover:text-white"onClick={() => setConfirmDeleteId(null)}>Cancel</Button>
